        ...
        foreach ($result as $aresult) {    // <!-- show all poems from tbl_poems start !-->
            ...
            <div id="all_poem_page_four_content">
                <div id="all_poem_page_by_title">
                    <a style="  font-weight:  normal; color: black; font-size: 13px; font-family: cursive" href="<?php echo base_url(); ?>user_admin_controller/poemdetail/<?php echo $aresult->poem_id; ?>" ><?php echo $aresult->title; ?></a></br></br>
                ...
                <div id="all_poem_page_image">
                    <img height="50" width="50" src="<?php echo base_url() ?><?php echo $aresult->picture_small; ?>"/> <!-- image show !-->
                </div>
            </div>
        <?php } ?>
    </div>
