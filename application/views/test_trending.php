...
<?php foreach ($result as $row) { ?>
    <div class="hideme"   id="all_trending_poem_wrapper">
            ...
            <section id="demo">
                <article>
                    ...
                    <div id="poem_detail">
                        ...
                        <span class="body"><div style="float: left; padding-left: 13px;"><?php echo $row->body; ?></div>
        ...
        <!--                                                <script>
                                                ...
                                                <!--- reply text drew with comments id start !--> 

                                               

                                                <!--- reply text drew with comments id end !--> 
                                                ...
                                                if ($user_id > 0) {
                                                    ...
                                                    <div id="Button1<?php echo $v_comments->comments_id; ?>" onclick="k()" style="float:right; height:25px; width: 55px; border:  #ddd solid 3px; border-radius: 31px; margin: 1px 0px 0px 0px;">
                                                        <b style="float:left; margin: 5px 0px 0px 11px; color: #555; font: normal 13px/13px 'Josefin Slab',Georgia; cursor: pointer; ">Reply</b></div>
                                            ...
                                            //alert ("You are using Microsoft Internet Explorer.");
                                                ...
                                                //If not, then use the older active x object.
                                                    try {
                                                    //If we are using Internet Explorer.                                                                 xmlhttp = new ActiveXObject("Microsoft.XMLHTTP");
                                                //alert ("You are using Microsoft Internet Explorer");
                                                } catch (E) {
                                                    //Else we must be using a non-IE browser.
                                                    xmlhttp = false;
                                    ...
                                    function saveReply(comment, poemId, CommentsId, userId, objId) {
                                        ...
                                        xmlhttp.send(null);
                                            ...
                                            <!-- end function save reply!-->                                                        
                                            <!-- reply text view and hide script start !--> 

                                            <div id="c1<?php echo $v_comments->comments_id; ?>" style="display:none;"><?php $reply_of = 'replyData' . $row->poem_id . $v_comments->comments_id; ?>

<!--                                                <textarea id="Text1" /></textarea>

                                                <button id="Button1" type="button" value="button" onclick="hide()" >Post</button>-->

                                           <textarea placeholder="Write a reply" title="Write a reply" name="<?php echo $reply_of; ?>" id="Text1<?php echo 'replyData' . $row->poem_id . $v_comments->comments_id; ?>"  style="float: left; height: 65px; width: 381px; border-radius: 7px; display: block; position: relative; outline: none;"></textarea><br><br><br><br><br><br>
                                            ...
                                            <!-- reply text view and hide script end !--> 



<!--                                                            <div id="a<?php echo $v_comments->comments_id; ?>"> <?php $reply_of = 'replyData' . $row->poem_id . $v_comments->comments_id; ?>
...
<?php } ?>
 ...
 <style type="text/css">
                                ...
                                <div id="Button1" onclick="k()" style="float:right; height:25px; width: 55px; border:  #ddd solid 3px; border-radius: 31px; margin: 1px 0px 0px 0px;">
                                <b style="float:left; margin: 5px 0px 0px 11px; color: #555; font: normal 13px/13px 'Josefin Slab',Georgia; cursor: pointer; ">Reply</b></div>
