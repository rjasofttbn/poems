...
<h4 style="float: left;">Statistics of your poems on poetsfeeling.Com.</h4>
<!--  <div id="left">  
      <div id="caption">
    ...
    <div id="banner_f">
        <div id="banner_caption">
            <div id="most_popular_poets_title">
                <b style=" float: left; font-size: 15px; text-align: left; margin: 0px 0px 0px 30px; ">Title</b>  
            </div>

            <div id="most_popular_country">
                <b style=" float: left; font-size: 15px; margin: 0px 0px 0px 310px; ">Submitted at</b>
            </div>

            <div id="most_popular_poem">
                <b style="float: left; font-size: 15px; text-align: left;  ">Hits</b>
            </div>

<!--            <div id="most_popular_poetstitle">
                <b style=" float: left; font-size: 15px; margin: 0px 0px 0px 3px; "></b>
            </div>-->

<!--            <div id="most_popular_meter">
                <b style="float: left; text-align: left; margin: 0px 0px 0px 0px;  font: 13px/15px sans-serif; color:royalblue; font-weight: normal;">[ <?php echo date('j- F- y', strtotime('today - 30 days')) ?> ---» <?php echo date('j- F- y'); ?> ]</b>
            </div>-->
        </div>
    </div>      
    <?php if (count($row) > 0) { ?>
        ...
        foreach ($most_popular_poem as $row) {
            $i++;
            ?>
            ...
            <div id="most_popular_poets">
                ...
                <div id="most_popular_poets_font">
                    <div style="float:left; text-align: left; font: 13px/18px sans-serif;  color:royalblue; font-weight:  bold; width: 55px; margin:0px 0px 0px 3px ;"><?php echo $i; ?>.</div>
                    <div style="float: left; text-align: left; color:#333; font: 13px/17px sans-serif; width:  470px; margin:0px 0px 0px 11px ;">
                        <?php echo $row->title; ?>
                    </div>

                    <div style="float: left; height: auto; text-align: left; color:#333; font: 13px/17px sans-serif; width:  170px; margin:  0px 4px 0px 5px;">
                        <?php echo $row->poem_submit_date; ?>
                    </div>

                    <div style="float: left; color: #333; font: 11px/13px; font-size: 14px; width: 150px; margin:0px 0px 0px 55px; ">
