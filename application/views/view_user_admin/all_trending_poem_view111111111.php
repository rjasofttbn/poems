                            ...
                            <li ><h2> <b style="font: normal 14px/14px sans-serif; color:#555;"><?php echo substr("$row->body", 0, 151); ?></b></h2>
                                <ul>
                                    <li>
                                        ...
                                        <div id="flip<?php echo $row->poem_id; ?>" style=" float: left; height: auto; min-width: 495px;" ><?php echo substr("$row->body", 0, 151); ?></div>
                                        <div id="panel<?php echo $row->poem_id; ?>" style=" float: left; height: auto; min-width: 500px;"><?php echo substr("$row->body", 151, 70000); ?></div>   
                        ...
                        <article>
                            ...
                            <div id="poem_detail">
                                ...
                                <span class="body"><div style="float: left; margin-left: 13px;"><?php echo $row->body; ?></div>
                                    ...
                                    <div style="float: left; min-height:73px; margin: 0px 0px 15px 0px;  width: 93%;    background-color:  #999;">
             ...
             xmlhttp.send(null);  }
                                    ...
                                    <div style="float: left; min-height:73px; margin: 0px 0px 15px 0px;  width: 93%;">
                                        ...
                                        <?php foreach ($comments[$row->poem_id] as $v_comments) { ?>
                                            <div style="float: left; min-height: 50px; width: 473px; margin: 3px 0px 0px 3px;">
