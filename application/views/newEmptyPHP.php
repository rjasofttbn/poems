    ...
    <div style="float: left;   height: auto; width: 660px; margin-top: 0px; ">
        ...
        <?php foreach ($two_tranding_poem as $row) { ?>
            <div id="all_trending_poem_wrapper">
                ...
                <div id="poem_detail">                  
                    <div id="flip<?php echo $row->poem_id; ?>"<b style="font: normal 14px/14px sans-serif; color:#555; margin-left: 51px;"><?php echo substr("$row->body", 0, 151); ?></b></div>
                    <div id="panel<?php echo $row->poem_id; ?>" <b style="font: normal 14px/14px sans-serif; color: #555; margin-left: 51px;"> <?php echo substr("$row->body", 151, 70000); ?></b>
                        <div style="float: left; height:73px; margin: 0px 0px 15px 0px;  width: 80%; box-shadow: 0px 1px 17px 1px silver;">
                            <div style="float: left;font: bold 14px/14px 'Josefin Slab'; color: #333;  height: 50%; width: 95%; margin: 11px 0px 0px 13px; ">
                                <div style="float: left;  height: 60%; width: 29%;  margin-top: 15px;">Read:  <?php echo $row->read_value; ?></div>
                                <div style="float: left;  height: 60%; width: 29%; margin-top: 15px;">Vote: <?php echo $row->poem_vote; ?></div>
                                <div style="float: left;  height: 60%; width: 29%; margin-top: 15px;">Comments: <?php echo $row->total_comments; ?></div>
                            </div>
                        </div>
                    ...
                    <script>
            $(document).ready(function() {
                $("#flip<?php echo $row->poem_id; ?>").click(function() {
                    $("#panel<?php echo $row->poem_id; ?>").slideDown(1000);
                });
                $("#stop<?php echo $row->poem_id; ?>").click(function() {
                    $("#panel<?php echo $row->poem_id; ?>").stop();
                });
            });
                    </script>

                    <style> 
                        #panel<?php echo $row->poem_id; ?>, #flip<?php echo $row->poem_id; ?> {
                            //padding: 5px;
                            float: left;
                            font-size: 18px;
                            width:100%;
                    ...
                    <section id="demo">
                        <article>
                            <div id="image">
                                ...
                                <?php
                                            if (!empty($row->picture_small)) {
                                                ?> 
                                                <img  height="50px" width="50px" style=" float: left; margin: 0px 7px 0px 0px; border-radius: 100px;"src="<?php echo base_url() ?><?php echo $row->picture_small; ?>"/>
                                                <?php
                                            } else {
                                                ?>
                            ...
                            <div id="poem_detail">
                                ...
                                <span class="body"><div style="float: left; margin-left: 13px;"><?php echo $row->body; ?></div>
                                    ...
                                    <div style="float: left; min-height:73px; margin: 0px 0px 15px 0px;  width: 93%;    background-color: whitesmoke;">
                                        <div style=" float: left; font: bold 15px/15px sans-serif; color: #666; text-align: left; margin:15px 0px 0px 67px; "> 
                                            ...
                                            <div style="float: left;"> 
                                                ...
                                                <b style="float: left;  font: bold 15px/15px sans-serif; color: #999; margin: 5px 0px 0px 15px;"><?php echo $row->total_like; ?></b>

                                                <b id="new_total_comments<?php echo $row->poem_id; ?>" style="float: left;  font: bold 15px/15px sans-serif; color: #999; margin: 5px 0px 0px 95px;">
                                                    <?php echo $row->total_comments; ?></b>

                                                <!--<b style="margin:0px 0px 0px 7px;">Vote:</b>-->
                                                <!--total vote view in this div-->
                                                <b id="new_total_vote<?php echo $row->poem_id; ?>" 
                                                   style="float: left;  font: bold 15px/15px sans-serif; color: #999; margin:5px 0px 0px 88px;">
                                                    <?php echo $row->total_vote; ?></b> 

                                                <b id="new_total_vote<?php echo $row->poem_id; ?>" 
                                                   style="float: left;  font: bold 15px/15px sans-serif; color:  #999; margin:5px 0px 0px 107px;">
                                                    <?php echo $row->read_value; ?></b> 
                                            ...
                                            <div title="Avarage Vote Rate Of The Poem." style="width: auto; height: 9px; color: #555;">
                                                ...
                                                <strong style="font:normal 15px/15px sans-serif;">
                                                    <b  id="new_average_vote<?php echo $row->poem_id; ?>" 
                                                        style="color:  tomato; "><?php echo round($row->Average_vote,2); ?></b>/10
                                                </strong>
