...
<html lang="en">
    <head>
        ...
        <link href='<?php echo base_url(); ?>css_admin/jquery.cleditor.css' rel='stylesheet'>
                ...
                <div class="span2 main-menu-span">
                    <div class="well nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            if ($access_label == 1) {
                                ?>
                                                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/administrators"><i class="icon-eye-open"></i><span class="hidden-tablet">Administrator</span></a></li>
                                <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/add_category_form"><i class="icon-eye-open"></i><span class="hidden-tablet"> Add Category</span></a></li>
                            <?php } ?>
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/category_manager""><i class="icon-edit"></i><span class="hidden-tablet"> Category Manager</span></a></li>
                            <?php
                            $access_label = $this->session->userdata('access_label');
                            if ($access_label == 1) {
                                ?>
                                <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/add_blog_form"><i class="icon-list-alt"></i><span class="hidden-tablet"> Add Blog</span></a></li>
                            <?php } ?>
