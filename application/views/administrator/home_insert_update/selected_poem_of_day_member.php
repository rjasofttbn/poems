...
<div id="user_data_view">
    <h1 style="text-align: left; margin-left: 5px">Selected Poem of The Day.</h1>
    ...
    <?php if (count($fiften_poem_of_day) > 0) { ?>
        <table border="1" align="center" style=" background-color:  white;  text-align: left; border-radius: 5px; ">
            ...
            foreach ($selected_poem_day_member as $poem_view) {
                $i++;
                ?>
                <tr style="background-color: #B2B2B2;">
                    ...
                    <td style="width: 3px;  border-radius: 5px;"><?php echo $poem_view->poem_day_member; ?></td>
                    <td style="  font-size: 12px; border-radius: 5px; "><?php echo $poem_view->poem_submit_date; ?></td>
                    <td style="  font-size: 12px; border-radius: 5px; "><?php echo $poem_view->poem_day_member_display_date; ?></td>
                    <td style="  font-size: 12px; border-radius: 5px; "><?php echo $poem_view->poem_of_day_member_selection_date; ?></td>
                    
                    <td>
                        <a style=" float: left; text-align:  center; color: blue; border-radius: 5px;" href="<?php echo base_url() ?>administrator_controller/poem_of_member_select_for_update/<?php echo $poem_view->poem_id ?>">Update</a>
