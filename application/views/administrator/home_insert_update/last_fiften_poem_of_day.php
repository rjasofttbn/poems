...
<div id="user_data_view">
    <h1 style="text-align: left; margin-left: 5px">Update Poem of The Day.</h1>
    ...
    <?php if (count($fiften_poem_of_day) > 0) { ?>
        <table border="1" align="center" style=" background-color:  white;  text-align: left; border-radius: 5px; ">
            <tr style="text-align: center; border-radius: 5px; background-color: #E2E2E2;">
                ...
                <th style="border-radius: 5px;">Poem Display Date</th>
                <th style="border-radius: 5px;">Poem Selection Date</th>
         ...
         <!--<th>Action</th>-->
            ...
            foreach ($selected_poem_day as $poem_view) {
                $i++;
                ?>
                <tr style="background-color: #B2B2B2; text-align: center;">
                    ...
                    <td style="font-size: 12px; text-align: left; border-radius: 5px; "><?php echo $poem_view->name; ?></td>
                    ...
                    <td style="  font-size: 12px; border-radius: 5px; "><?php echo $poem_view->top_poem; ?></td>
                    <td style="  font-size: 12px; border-radius: 5px; "><?php echo $poem_view->poem_of_day_display_date; ?></td>
                    <td style="  font-size: 12px; border-radius: 5px; "><?php echo $poem_view->poem_of_day_selection_date; ?></td>
                   
                    <td>
                        <a style=" float: left; text-align:  center; color: blue; border-radius: 5px;" href="<?php echo base_url() ?>administrator_controller/poem_of_day_select_for_update/<?php echo $poem_view->poem_id ?>">Update</a>
