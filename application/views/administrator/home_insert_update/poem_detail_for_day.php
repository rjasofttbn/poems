...
<div style="height: auto; width: auto;">
    <div style="margin-top: 45px; margin-bottom: 45px;">
        ...
        <form name="poem_detail_for_day" action="<?php echo base_url(); ?>administrator_controller/poem_of_day_data_insert" method="post">
            ...
            <table  class="table table-striped" cellpadding="0" cellspasing="0" class="sortable zebra tablesorter tablesorter-default" id="articles-table" align="center" style=" border:#000;" border="1">
                ...
                <tr style=" text-align:left">
                    ...
                    <td>                       
                        <?php if ($poem_view->poem_of_day_display_date < 1) { ?> 
                ...
                <tr>
                    <?php if ($poem_view->poem_of_day_display_date < 1) { ?> 
                        <td>&nbsp;</td>
                    <td>                       
                        <input style="font:bold 15px/16px sans-serif; cursor: pointer;" type="submit" name="btnupdate" value="Poem Of The Day Select"/>
                    </td>
                <?php } ?>
                </tr>
            </table>
