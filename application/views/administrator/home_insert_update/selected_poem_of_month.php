...
<div id="user_data_view">
    ...
    <?php if (count($fiften_poem_of_day) > 0) { ?>
     ...
     <!--<th>Action</th>-->
            ...
            foreach ($last_fiften_poem as $poem_view) {
                $i++;
                ?>
                <tr style="background-color: #B2B2B2;">
                    ...
                    <td style="  font-size: 12px; border-radius: 5px; "><?php echo $poem_view->poem_of_month_selection_date; ?></td>
                    
                    <td>
                        <a style=" float: left; text-align:  center; color: blue; border-radius: 5px;" href="<?php echo base_url() ?>administrator_controller/poem_of_month_select_for_update/<?php echo $poem_view->poem_id ?>">Edit</a>
