...
<div id="user_data_view">
    <h1 style="text-align: left; margin-left: 5px">Poems View</h1>
    ...
    <?php if (count($poem_view) > 0) { ?>
        <table border="1" align="center" style=" background-color:  white;  text-align: left; border-radius: 5px; ">
            <tr style="text-align: center; border-radius: 5px; background-color: #E2E2E2;">
                ...
                <th style="border-radius: 5px;">Act Status</th>
            ...
            foreach ($poem_view as $poem_view) {
                ...
                <tr style="background-color: #B2B2B2;">
                    ...
                    <td style=" border-radius: 5px;"><?php echo $poem_view->title; ?></td>
                    <td <span style=" font-size: 14px; color: black; border-radius: 5px;  "></span><?php echo substr("$poem_view->body", 0, 21); ?>---</td>
                    <td style=" border-radius: 5px;"><?php echo $poem_view->poem_activation; ?></td>
                    <td style=" font-size: 12px; border-radius: 5px; "><?php echo $poem_view->poem_submit_date; ?></td>
                    <td>
                        <a style="color: blue; border-radius: 5px;" href="<?php echo base_url() ?>administrator_controller/poem_control_data_detail/<?php echo $poem_view->poem_id ?>">Edit</a>&nbsp;&nbsp;|&nbsp;&nbsp;
