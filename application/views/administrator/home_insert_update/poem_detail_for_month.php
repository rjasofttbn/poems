...
<h1 style="text-align: left; margin-left: 5px">Poem Of The Month Select</h1>
...
<div style="height: auto; width: auto;">
    ...
    <div style="margin-top: 45px; margin-bottom: 45px;">
        ...
        <form name="poem_detail_for_month" action="<?php echo base_url(); ?>administrator_controller/poem_of_month_data_insert" method="post">
            ...
            <table  class="table table-striped" cellpadding="0" cellspasing="0" class="sortable zebra tablesorter tablesorter-default" id="articles-table" align="center" style=" border:#000;" border="1">
                ...
                <tr style=" text-align:left">
                    <td style="font: bold 15px/16px sans-serif; color: #333;">Poem Of The Month</td>
                    <td>
                        <div id="poem_close_font">(pom) By this data poem will be poem of the month</div><br>
                        <input type="text" disabled="" style=" font-weight: bolder; border-style:  none; color: red; text-align: center; margin: 3px 0px 0px 3px;" name="poem_of_month" size="3px" maxlength="10" required="1" value="<?php echo $poem_view->poem_of_month ?>" />                    
                    </td>
                </tr>
                <tr style=" text-align:left">
                    <td style="font: bold 15px/16px sans-serif; color: #333;">Which date poem will be display?</td>
                    <td>                       
                        <?php if ($poem_view->poem_month_display_date < 1) { ?> 
                            <div id="poem_close_font">Please date select for Poem of the month</div><br>
                            <input style=" margin: 3px 0px 0px 3px; " autofocus=""  type="date" name="poem_month_display_date"  required="1"  min="2015-01-01"><br>
                        <?php } ?>                     
                        <?php if ($poem_view->poem_month_display_date > 1) { ?> 
                            <div id="poem_close_font">This Poem all ready poem of the month selected</div><br>
                            <div style="float: left; background-color: whitesmoke; font-weight: bold; color: red; margin: 3px 0px 0px 3px; width: 97px; text-align: center; height: 21px;"><?php echo $poem_view->poem_month_display_date ?></div><br><br>
                        <?php } ?>
                ...
                <tr>
                    <?php if ($poem_view->poem_month_display_date < 1) { ?> 
                        <td>&nbsp;</td>
                    <td>                       
                        <input style="font:bold 15px/16px sans-serif; cursor: pointer;" type="submit" name="btnupdate" value="Poem Of The Month Select"/>
                    </td>
                <?php } ?>
                </tr>
            </table>
