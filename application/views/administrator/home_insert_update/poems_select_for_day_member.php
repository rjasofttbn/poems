...
<div id="user_data_view">
    <h1 style="text-align: left; margin-left: 5px">Poem of The Day Member Select</h1>
        ...
        <table border="1" align="center" style=" background-color:  white;  text-align: left; border-radius: 5px; ">
            ...
            foreach ($poem_view as $poem_view) {
                ...
                <tr style="background-color: #B2B2B2;">
                    ...
                    <td style=" width: 151px; border-radius: 5px;"><?php echo $poem_view->name; ?></td>
                    ...
                    <td>
                        <a style=" float: left; text-align:  center; color: blue; border-radius: 5px;" href="<?php echo base_url() ?>administrator_controller/poem_of_member_select/<?php echo $poem_view->poem_id ?>">Edit</a>
