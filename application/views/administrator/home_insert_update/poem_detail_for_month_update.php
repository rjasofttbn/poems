...
<h1 style="text-align: left; margin-left: 5px">Poem of the month date change</h1>
...
<div style="height: auto; width: auto;">
    <div style="margin-top: 45px; margin-bottom: 45px;">
        ...
        <form name="poem_detail_for_month" action="<?php echo base_url(); ?>administrator_controller/poem_of_month_data_update" method="post">
            ...
            <table  class="table table-striped" cellpadding="0" cellspasing="0" class="sortable zebra tablesorter tablesorter-default" id="articles-table" align="center" style=" border:#000;" border="1">
                ...
                <tr>
                        ...
                        <td>&nbsp;</td>
                    <td>                       
                        <input style="font:bold 15px/16px sans-serif; cursor: pointer;" type="submit" name="btnupdate" value="Poem of the month date change"/>
                    </td>
