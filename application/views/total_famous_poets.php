...
<div id="famous_poet_total">
    ...
    <h1 style=" text-align: left; color: skyblue; ">Famous Poet's :<b style="color: #B57430;"> ( <?php echo $row->famous_poet; ?> )</b>.</h1>
     <?php } ?>
    <div id="left">
        <div id="poems_menu"> 
            <div id="title">
                <b style=" float: left; margin: 27px 0px 0px 27px; color: #333;">Poems Menu's</b> 
            </div>
            <div id="menu" > 
        ...
        <?php if (count($result) > 0) { ?>
            ...
            if ($i == NULL) {
                ...
                <div id="value">
                    ...
                    <div id="name">
                        <a title="Famous Poet" style="font: normal 14px/14px sans-serif; color:tomato; " href="<?php echo base_url(); ?>poems/poet_personal_info/<?php echo $row->user_id; ?>"><?php echo substr("$row->name", 0, 101); ?>...</a>
                    </div>
                    <div id="picture">
    ...
    <div id="right">
        <div id="right_title">
            <div id="value">Famous Poem's</div>
        </div>
        <?php foreach ($poem_famous as $row) { ?>
