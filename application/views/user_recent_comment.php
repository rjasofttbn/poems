...
<div style="float: left; min-height: 50px; width: 473px; margin: 31px 0px 0px 0px;">
    ...
    <div style="float: left;  font: normal 15px/15px 'Josefin Slab',Georgia; color: #333;  padding: 11px; text-align: justify; text-shadow: 1px 1px 1px #fff; display: block; position: relative; ">
        <?php echo $comments; ?>
    </div><br>
</div>
</div>
